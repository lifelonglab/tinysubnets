...
class SubnetAlexNet_norm(nn.Module):
    def __init__(self,taskcla, sparsity=0.5):
        ...
        self.in_channel =[]
        self.conv1 = SubnetConv2d(3, 64, 4, sparsity=sparsity, bias=False)
        self.quant1 = QuantLayer(weight_shape=self.conv1.weight.data.numpy().shape, quantization_procedure=linear_cadence_hist, word_length=4)
        ...
        self.in_channel.append(3)
        self.conv2 = SubnetConv2d(64, 128, 3, sparsity=sparsity, bias=False)
        self.quant2 = QuantLayer(weight_shape=self.conv2.weight.data.numpy().shape, quantization_procedure=linear_cadence_hist, word_length=4)
        ...
        self.in_channel.append(64)
        self.conv3 = SubnetConv2d(128, 256, 2, sparsity=sparsity, bias=False)
        self.quant3 = QuantLayer(weight_shape=self.conv3.weight.data.numpy().shape, quantization_procedure=linear_cadence_hist, word_length=4)
        ...
        self.fc1 = SubnetLinear(256*self.smid*self.smid, 2048, sparsity=sparsity, bias=False)
        self.quant_l1 = QuantLayer(weight_shape=self.fc1.weight.data.numpy().shape, quantization_procedure=linear_cadence_hist, word_length=4)
        ...
        self.fc2 = SubnetLinear(2048, 2048, sparsity=sparsity, bias=False)
        self.quant_l2 = QuantLayer(weight_shape=self.fc2.weight.data.numpy().shape, quantization_procedure=linear_cadence_hist, word_length=4)
