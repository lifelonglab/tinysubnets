...
class IncrementalLoader:
    ...
    def get_dataset_info(self):
        if (self._opt.dataset == 'tinyimagenet'):
            n_inputs = 3*64*64
            input_size = [3, 64, 64]
        elif (self._opt.dataset == 'imagenet' or self._opt.dataset == 'imagenet100'):
            n_inputs = 3*224*224
    ...
    def _get_loader(self, x, y, shuffle=True, mode="train"):
        ...
        return DataLoader(
            DummyDataset(x, y, trsf, pretrsf=pretrsf, imgnet_like = True),
    ...
    def _setup_data(self, datasets, class_order_type=False, seed=1, increment=10, validation_split=0.):
        ...
        for dataset in datasets:
            ...
            if (self._opt.dataset == 'tinyimagenet' or self._opt.dataset == 'imagenet' or self._opt.dataset == 'imagenet100'):
