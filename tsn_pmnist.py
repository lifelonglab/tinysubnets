...
def main(args):
    ...
    for k, ncla in taskcla:
        ...
        #kl between tasks
        #if quite high arrange new subnet
        ...
        if save_flag:
            ...
            if task_id < 10:
                #saver_dict[task_id]['per_task_masks'] = model.module.get_masks(task_id)
                #saver_dict[task_id]['consolidated_masks'] = consolidated_masks
                #saver_dict = save_model_params(saver_dict, model, task_id)
                #saver_dict[task_id]['per_task_masks'] = models[0].module.get_masks(task_id)
                ...
                #saver_dict[task_id]['per_task_masks'] = models[1].module.get_masks(task_id)
